...
train_folders = { 'letter':['letter_a', 'letter_h'] }  # 分类关键词
sample_rate, sensor_sample_rate_now = 1, 4800  # 数据降维  / 硬件采样率
...
# 预处理
saved_dimension_after_pca, sigma = 30 , 5  # 如果算出只取一列，会在PCA函数中被重置
...
train_keyword = ['letter_a', 'letter_h']
